...
C {vsource.sym} 750 -150 0 0 {name=V_IN value="pulse(0 1.8 \{td\} 50p 50p 9n 18n)" savecurrent=false}
...
.control
  save all
  set filetype=ascii
  shell rm -f /home/sushanth/.xschem/simulations/delay_results.txt
  ...
  while td <= 5.05n
    ...
    echo $&td,$&delay >> /home/sushanth/.xschem/simulations/delay_results.txt
