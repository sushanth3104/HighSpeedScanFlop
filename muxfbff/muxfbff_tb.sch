...
C {vsource.sym} 40 -510 0 0 {name=V1 value="pulse(0 1.8 -5.8n 50p 50p 16n 36n)" savecurrent=false}
...
C {vsource.sym} 240 -230 0 0 {name=V5 value="pulse(0 1.8 1n 50p 50p 5n 10n)" savecurrent=false}
C {gnd.sym} 240 -160 0 0 {name=l5 lab=0}
C {vsource.sym} 290 -170 0 0 {name=V6 value="pulse(1.8 0 1n 50p 50p 5n 10n)" savecurrent=false}
...
.control
  save all
    run
	meas tran delay TRIG v(C) VAL=0.9 RISE=2 TARG v(Q) VAL=0.9 RISE=1
	print v(c),v(din),v(q) > outputsim.csv
  end
.endc
